...
bash
Copy code
git clone https://github.com/air-teng/bedroom_manage.git
创建MySQL数据库，将项目中的bedroom_manage.sql文件导入到新建的数据库中。

修改src/main/resources/application.properties文件，将数据库连接信息设置为你自己的数据库配置。
...
打开浏览器，访问http://localhost:8080，开始使用学生公寓管理系统。
